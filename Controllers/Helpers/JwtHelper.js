...
let privateKEY = read.sync('config/cert/myKey.pem', 'utf8');;
let privateRefKEY = read.sync('config/cert/myrefKey.pem', 'utf8');;
let publicRefKEY = read.sync('config/cert/myrefKey.pub', 'utf8');;
